...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOpCRIntake", group = "TeleOp")
public class TeleOpCRIntake extends OpMode {
    ...
    CRServo intakeServo; // This object is temporary
