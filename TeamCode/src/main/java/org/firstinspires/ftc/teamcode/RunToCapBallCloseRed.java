...
@Autonomous(name = "CapBallTimeCloseRed", group = "Testing")
public class RunToCapBallCloseRed extends OpMode {
    ...
    public void loop() {
        ...
        if (stage == 1) {//drive forward for turn
        ...
        if (stage == 3) {//drive on heading 0 for 2 seconds
            if (waitTime.time() <= 2) {
                driveOnHeading(0, 1);
            } else {
                powerLeft(0);
