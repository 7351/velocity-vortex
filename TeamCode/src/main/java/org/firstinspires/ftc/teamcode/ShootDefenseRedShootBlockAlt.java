...
@Autonomous(name = "ShootDefenseRedShootBlockAlt", group = "Encoder Autonomous")
public class ShootDefenseRedShootBlockAlt extends OpMode {
    ...
    public void loop() {
       ...
       /* if (stage == 0) {//calibrates to 0
        ...
        if (stage == 13){//turn to block spot
            if (turn == null){
